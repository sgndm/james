...
<?php
      ...
      $l_obj = $ux->getTableRecord($p_obj,"symptoms_list","id",$p_record_id);
      ...
      $dlim=";_;";
      $l_arr[$l_arr_ctr++]="Symptom" . $dlim ."symptom". $dlim ." text". $dlim ."1" . $dlim . $p_rec["symptom"];
      $l_arr[$l_arr_ctr++]="URL" . $dlim ."url". $dlim ." text". $dlim ."0" . $dlim . $p_rec["url"];
      $fieldtotal = $l_arr_ctr;

?>
<h4 class='login-box-head'>Symptom</h4>
...
<BR/>
  ...
  <BR/>
			...
			<div class='login-actions'>
				<input type="button"  onClick="callme('record,symptom,')" value="Save" />
<input type="button"  onClick="callform('symptomlist.php')" value="Go Back" />
			</div>
</div>
