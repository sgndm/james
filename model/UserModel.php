...
{ 
	...
	public function savePatient()
  {
         ...
         $l_url = $this->getPhotoURL($l_flname,TRUE, $l_uniqueid, TRUE);
             ...
             $fields =   " first_name,last_name,discharge_diagnosis, ignore_execptions, surgical_procedure  ,medical_record_url,  clinic_id,doctor_id,phone,dial_code,phone_carrier,reason,email,username,password,photourl,created_ts,created_user_id,updated_ts,updated_user_id";
