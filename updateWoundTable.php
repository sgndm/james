...
<tr >
<th style="width=30%" >Wound Care</th>
...
<?php
      for ( $idx =0; $idx <$fieldtotal; $idx++)
      {
       ...
       if ( $c_no  < $start_rowid || $c_no > $end_rowid )
       {
         ...
         $l_record_id  =  $rec["id"];
         $l_wound  =  $rec["description"];
         $l_url  =  $rec["url"];
      ?>
<tr bgcolor="white"
    onclick="callform('wound.php',<?php echo $l_record_id; ?>,'patient')">
<td style="width:30%" >
 <a href="#" class="top-create-account"><font color='blue'> <?php echo $l_wound; ?></font> </a> 
</td>
