(function() {
  ...
  $(function() {
    ...
    $('.top-sign-in, .top-create-account').on("click", function(e) {
    ...
    //kumar
    $('.top-create-account').on("click", function(e) {
      $('.signup-box').fadeIn("fast");
      return false;
    });
    $('.signup-box-close').on("click", function(e) {
      $(this).closest(".signup-box").fadeOut("fast");
      return false;
    });
    //kumar
    prettyPrint();
