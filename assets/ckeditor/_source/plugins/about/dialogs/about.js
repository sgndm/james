						...
						html :
							...
							'<div class="cke_about_container">' +
								...
								'<p>' +
									...
									'<a href="//ckeditor.com/">http://ckeditor.com</a>' +
								'</p>' +
								'<p>' +
									lang.help.replace( '$1', '<a href="//docs.cksource.com/CKEditor_3.x/Users_Guide/Quick_Reference">' + lang.userGuide + '</a>' ) +
								'</p>' +
								'<p>' +
									lang.moreInfo + '<br>' +
									'<a href="//ckeditor.com/license">http://ckeditor.com/license</a>' +
								'</p>' +
								'<p>' +
									lang.copy.replace( '$1', '<a href="//cksource.com/">CKSource</a> - Frederico Knabben' ) +
								'</p>' +
							'</div>'
					}
				]
