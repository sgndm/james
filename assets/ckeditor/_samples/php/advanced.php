...
<body>
	...
	<p>
		To set configuration options, use the <a class="samples" href="//docs.cksource.com/ckeditor_api/symbols/CKEDITOR.config.html"><code>config</code></a> property. To set the attributes of a <code>&lt;textarea&gt;</code> element (which is displayed instead of CKEditor in unsupported browsers), use the <code>textareaAttributes</code> property.
	</p>
	<pre class="samples">
&lt;?php
...
// The initial value to be displayed in the editor.
$initialValue = '<p>This is some <strong>sample text</strong>. You are using <a href="//ckeditor.com/">CKEditor</a>.</p>';
