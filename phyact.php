...
<?php
      ...
      $l_obj = $ux->getTableRecord($p_obj,"physical_activity_list","id",$p_record_id);
      ...
      $dlim=";_;";
      $l_arr[$l_arr_ctr++]="Physical Activity" . $dlim ."physicalactivity". $dlim ." text". $dlim ."1" . $dlim . $p_rec["physical_activity"];
...
?>
  ...
  &nbsp;&nbsp;Is Active
			...
			<div class='login-actions'>
				<input type="button"  onClick="callme('record,savephyactlist,')" value="Save" />
<input type="button"  onClick="callform('phyactlist.php')" value="Go Back" />
			</div>
</div>
