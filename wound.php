...
<?php
      ...
      $l_obj = $ux->getTableRecord($p_obj,"wound_care_list","id",$p_record_id);
      ...
      $dlim=";_;";
      $l_arr[$l_arr_ctr++]="Wound Care" . $dlim ."description". $dlim ." text". $dlim ."1" . $dlim . $p_rec["description"];
      $l_arr[$l_arr_ctr++]="URL" . $dlim ."url". $dlim ." text". $dlim ."0" . $dlim . $p_rec["url"];
      $fieldtotal = $l_arr_ctr;

?>
<h4 class='login-box-head'>Wound Care</h4>
...
?>
  ...
  &nbsp;&nbsp;Is Active
            ...
            <div class='login-actions'>
                <input type="button"  onClick="callme('record,savewoundlist,')" value="Save" />
<input type="button"  onClick="callform('woundcarelist.php')" value="Go Back" />
            </div>
</div>
