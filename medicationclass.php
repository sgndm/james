...
<?php
      ...
      $l_obj = $ux->getTableRecord($p_obj,"medications_class","id",$p_record_id);
      ...
      $dlim=";_;";
      $l_arr[$l_arr_ctr++]="Class" . $dlim ."description". $dlim ." text". $dlim ."1" . $dlim . $p_rec["description"];
      $fieldtotal = $l_arr_ctr;
?>
<h4 class='login-box-head'>Medication Class</h4>
...
?>
  ...
  &nbsp;&nbsp;Is Active
			...
			<div class='login-actions'>
				<input type="button"  onClick="callme('record,savemedicationclasslist,')" value="Save" />
<input type="button"  onClick="callform('medicationclasslist.php')" value="Go Back" />
			</div>
</div>
