...
<?php
      ...
      $l_obj = $ux->getTableRecord($p_obj,"videos_list","id",$p_record_id);
      ...
      $dlim=";_;";
      $l_arr[$l_arr_ctr++]="Video" . $dlim ."video". $dlim ." text". $dlim ."1" . $dlim . $p_rec["video"];
      $l_arr[$l_arr_ctr++]="URL" . $dlim ."url". $dlim ." text". $dlim ."1" . $dlim . $p_rec["url"];
      $fieldtotal = $l_arr_ctr;

?>
<h4 class='login-box-head'>Video</h4>
...
<div class='row' style="width:300;height:300;display:block" id="play_video_div">
<div class='span2'>
</div>
<div class='span6'>
<iframe controls="controls" style="height:300;width:300" src="" id="play_video_url"></iframe>
</div>
</div>
			<div class='login-actions'>
<input type="button" onClick="callme('record,video,')" value="Save" />
<input type="button" onClick="playvideo()" value="Play Video" />
<input type="button" onClick="callform('videolist.php')" value="Go Back" />
			</div>
</div>
