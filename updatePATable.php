...
<tr >
<th style="width=30%" >Physical Activity</th>
...
<?php
      for ( $idx =0; $idx <$fieldtotal; $idx++)
      {
       ...
       if ( $c_no  < $start_rowid || $c_no > $end_rowid )
       {
         ...
         $l_record_id  =  $rec["id"];
         $l_physicalactivity  =  $rec["physical_activity"];
         $l_url  =  $rec["url"];
      ?>
<tr bgcolor="white"
    onclick="callform('phyact.php',<?php echo $l_record_id; ?>,'patient')">
<td style="width:30%" >
 <a href="#" class="top-create-account"><font color='blue'> <?php echo $l_physicalactivity; ?></font> </a> 
</td>
